...
const equipamentosRoutes_1 = __importDefault(require("./routes/equipamentosRoutes"));
const app = (0, express_1.default)();
app.use(express_1.default.json());
// Rotas
app.use('/builds', buildsRoutes_1.default);
app.use('/armas', armasRoutes_1.default);
app.use('/equipamentos', equipamentosRoutes_1.default);
// Middleware de erro
